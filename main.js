const questions = [
  ...
  { id: '2° Quais conteúdos vão ser acessados com mais frequência?', text: 'Quais conteúdos vão ser acessados com mais frequência?', answers: ['Redes sociais: facebook, Instagram, whatsapp', 'streaming e vídeo: YouTube, Netflix, prime video, Amazom', 'Todas as respostas'] },
  { id: '3° A internet vai ser utilizada para fazer chamadas de vídeo ou trabalhar?', text: 'A internet vai ser utilizada para fazer chamadas de vídeo ou trabalhar?', answers: ['Sim, todos os dias', 'Sim, poucas vezes', 'Não'] },
